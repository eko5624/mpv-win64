...
pkgs['mpv'] = x['mpv']
for p in ['brotli', 'dav1d', 'ffnvcodec', 'freetype2', 'fribidi', 'harfbuzz', 'highway', 'lame', 'lcms2', 'libass', 'libbluray', 'libbs2b', 'libcaca', 'libdvdcss', 'libdvdnav', 'libdvdread', 'libjpeg', 'libjxl', 'libmfx', 'libmodplug', 'libmysofa', 'libogg', 'libopenmpt', 'libplacebo', 'libpng', 'libsdl2', 'libsixel', 'libsoxr', 'libspeex', 'libssh', 'libsrt', 'libwebp', 'libxml2', 'libxvid', 'libzimg', 'mbedtls', 'mujs', 'openal-soft', 'opus', 'rubberband', 'shaderc', 'spirv-cross', 'vulkan', 'zlib']:
  pkgs['%s-dev' % p] = x[p]
for p in pkgs:
